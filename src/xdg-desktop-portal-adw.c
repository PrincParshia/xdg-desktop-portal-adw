...
on_name_acquired (GDBusConnection *connection,
                  ...
                  gpointer         user_data)
{
  g_debug ("org.freedesktop.impl.portal.desktop.adw acquired");
}
...
main (int argc, char *argv[])
{
  ...
  g_option_context_set_description (context,
      "xdg-desktop-portal-adw provides D-Bus interfaces that\n"
      ...
      "\n"
      "Please report issues at https://github.com/PrincParshia/xdg-desktop-portal-adw/issues");
  ...
  g_set_prgname ("xdg-desktop-portal-adw");
  ...
  owner_id = g_bus_own_name (G_BUS_TYPE_SESSION,
                             "org.freedesktop.impl.portal.desktop.adw",
